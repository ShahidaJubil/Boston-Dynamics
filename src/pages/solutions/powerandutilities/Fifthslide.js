...
<h1 className={classes.resourcetitle}>RESOURCES</h1>
    ...
    <Item className={classes.grid6item}>
            <Card sx={{ maxWidth: 530 }}  className={classes.resourcecard1} >
                ...
                <Typography variant="body2" color="#00355A" textAlign="left"  id={classes.card6p}>
                    Discover how agile mobile robots are performing tedious and hazardous work and uncover how agile
                    mobile robots succeed where other automation alternatives fail.
                </Typography>
    ...
    <Item className={classes.grid6item}>
            <Card sx={{ maxWidth: 530 }} className={classes.resourcecard}>
                ...
                <Typography variant="body2" color="#00355A" textAlign="left"  id={classes.card6p}>
                Spot, an agile mobile robot, helps the nuclear power industry perform 
                inspection tasks in radiation zones that are unsafe for humans.
                </Typography>
