    ...
    <div>
                ...
                <Card sx={{ maxWidth: 530 }} className={classes.resourcecard1}>
                  ...
                  <div className={classes.cardcontent}>
                    <CardContent>
                      ...
                      >
                        BREAK THROUGH SUPPLY CHAIN BLOCKS WITH AUTOMATED
                        CONTAINER UNLOADING
                      </Typography>
                      <Typography
                        variant="body2"
                        ...
                        id={classes.card6p}
                      >
                        Automated container unloading helps alleviate supply
                        chain bottlenecks and create safer working conditions.
                      </Typography>
                    </CardContent>
                  ...
                  <div className={classes.cardcontent}>
                    <CardContent>
                      ...
                      <Typography
                        ...
                        id={classes.card6p}
                      >
                        After launching our warehouse robot Stretch at MODEX
                        2022, we heard from warehouse and materials handling
                        professionals with a few consistent themes.
                      </Typography>
                    </CardContent>
      ...
      <div className={classes.div6}>
        <div className="post1" data-aos="fade-up" data-aos-duration="4s">
          <h1 id={classes.autohead}>
            GET STARTED WITH FLEXIBLE WAREHOUSE AUTOMATION.
          </h1>
          <Button variant="outlined" id={classes.autobut1}>
            LEARN ABOUT STRETCH
          </Button>
          <Button variant="outlined" id={classes.autobutton}>
            CONTACT SALES
          </Button>
        </div>
      </div>
